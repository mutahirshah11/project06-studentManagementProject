    ...
    [
        {
            ...
            validate : function(input:string){                // using validate to give error if user dosen't enters a value
                if(input.trim() !== ""){
                    return true
                }else{
...
const tutionFee: {[key : string]:number}= {               // tutuion fee for each course 
      "Typescript" : 1500, 
      "Python" : 2200, 
      "React" : 3000, 
      "Next.js" : 6300, 
